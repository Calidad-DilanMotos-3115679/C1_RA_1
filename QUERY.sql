...
-- Inserción de Referencias (Catálogo)
...
INSERT INTO productos (id_categoria, nombre, descripcion, precio, imagenUrl) VALUES
(1, 'Aceite - ProMax 10W-40', 'Lubricante sintético para alto rendimiento', 45999, 'https://i.ibb.co/1Gv5jW4J/Aceite-Pro-Max-10-W-40.png'),
(1, 'Aceite - MOBIL Super 2000 10W-40', 'Tecnología semisintética para una protección superior en la conducción diaria', 49990, 'https://i.ibb.co/JTrtXgR/Aceite-MOBIL-Super-2000-10-W-40.png'),
(1, 'Aceite - Castrol Power1 10W-40', 'Lubricante sintético con tecnología de carreras para máxima aceleración', 52900, 'https://i.ibb.co/dw2CMkTp/Aceite-Castrol-Power1-10-W-40.png'),
(2, 'Llanta - Pirelli Angel City', 'Llanta versátil para ciudad y carretera', 195100, 'https://i.ibb.co/yBZxc6wv/Llanta-Pirelli-Angel-City.png'),
(2, 'Llanta - Michelin Pilot Street 2 90/90-18 TL', 'Llanta Sellomatic para motos de baja cilindrada', 235900, 'https://i.ibb.co/chvYJcG4/Llanta-Michelin-Pilot-Street-2-90-90-18-TL.png'),
(2, 'Llanta - Dunlop Sportmax GPR-300', 'Llanta de alto agarre y excelente rendimiento en piso mojado y seco', 245000, 'https://i.ibb.co/k2FSbbSc/Llanta-Dunlop-Sportmax-GPR-300.png'),
(3, 'Kit de arrastre - RK Takasago 14/45', 'Kit reforzado para motos deportivas', 210000, 'https://i.ibb.co/0WS1qYz/Kit-de-arrastre-RK-Takasago-14-45.png'),
(3, 'Kit de arrastre - DID Professional 15/46','kit reforzado para motos',225000, 'https://i.ibb.co/XxgYR1px/Kit-de-arrastre-DID-Professional-15-46.png'),
(3, 'Kit de arrastre - Cassarella Racing 14/42', 'Kit reforzado de alta durabilidad con acero certificado para competencia', 185000, 'https://i.ibb.co/Txjq5Ttc/Kit-de-arrastre-Cassarella-Racing-14-42.png');
